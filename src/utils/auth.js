...
//1. make an empty authentication object("token",userId) with empty values to hold the info token and userid
const emptyAuth = {
  "token": "",
  "userId": ""
}
//2. create a logout function for scenario when log out the localstorage "auth" 
...
// 3. create getUserId function for scenario when user log in retrive the user ID from localstorage
...
// 4. create getTokenFromLocalStorage function for scenario when user log in retrive the token from localstorage
...
//6. create authenticateUser function to send POST request to /signin' endpoint
